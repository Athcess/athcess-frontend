...
import { getPost, postLike } from "../../Services/HomeAPI";

export default function PostInteraction({ adata }) {
  ...
  async function toggleLike() {
    mutationLike.mutate({
      postId: adata.post_id,
    });
  }
  useEffect(() => {}, [postData.data]);
  if (postData.data) {
    console.log(postData.data.data, Cookies.get("auth_username"));
  }
    ...
    return (
      <div className={styles.container}>
        <UnstyledButton onClick={toggleLike}>
          {postData.data.data.likes
            .split(",")
            .includes(Cookies.get("auth_username")) ? (
        ...
        <Modal
          ...
          <div className={styles.postcontent}>
            ...
            <video className={styles.postVideo} controls>
              <source
                src="/Videos/1996750-hd_1920_1080_25fps.mp4"
                type="video/mp4"
              />
